...
//        // Set appearance
//        [_doneButton setBackgroundImage:[UIImage imageNamed:@"photo_browser_close"] forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
...
//        // Appearance
//        [newBackButton setBackButtonBackgroundImage:@"" forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
//             previousViewController.navigationItem.backBarButtonItem = newBackButton;
//    }

    _shareButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [_shareButton setFrame:CGRectMake(20, 60, 45, 45)];
    [_shareButton setAlpha:1.0f];
    [_shareButton addTarget:self action:@selector(actionButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [_shareButton setImage:[UIImage imageNamed:@"save_image.png"] forState:UIControlStateNormal];
    _shareButton.contentMode = UIViewContentModeScaleAspectFit;
    [self.view addSubview:_shareButton];
    
    _closeBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [_closeBtn setFrame:CGRectMake(self.view.frame.size.width-20-45, 60, 45, 45)];
    [_closeBtn setAlpha:1.0f];
    [_closeBtn addTarget:self action:@selector(doneButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
    [_closeBtn setImage:[UIImage imageNamed:@"photo_browser_close"] forState:UIControlStateNormal];
    _closeBtn.contentMode = UIViewContentModeScaleAspectFit;
    [self.view addSubview:_closeBtn];

    
    
//    UIButton *buttonUser2 = [UIButton buttonWithType:UIButtonTypeCustom];
//    [buttonUser2 setImage:[UIImage imageNamed:@"photo_browser_close"] forState:UIControlStateNormal];
//    [buttonUser2 addTarget:self action:@selector(doneButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
//    // [viewButtons addSubview:buttonUser];
//    
//    
//    buttonUser2.frame = CGRectMake(0, 0, 25, 25);
//    UIBarButtonItem *negativeSpacer = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFixedSpace target:nil action:nil];
//    [negativeSpacer setWidth:-10];
//    UIBarButtonItem *customBarRightBtn2 = [[UIBarButtonItem alloc] initWithCustomView:buttonUser2];
//    customBarRightBtn2.tintColor=[UIColor blueColor];
//    
//    
////    self.navigationItem.leftBarButtonItems = [NSArray arrayWithObjects:negativeSpacer,customBarRightBtn2,nil];
//    self.navigationItem.rightBarButtonItems = [NSArray arrayWithObjects:negativeSpacer,customBarRightBtn2,nil];
//
    // Toolbar items
    BOOL hasItems = NO;
