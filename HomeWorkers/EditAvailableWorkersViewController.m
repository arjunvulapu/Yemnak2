//
//  EditAvailableWorkersViewController.m
//  HomeWorkers
//
...
@interface EditAvailableWorkersViewController ()<PopViewControllerDelegate>
{
    UIButton *buttonUser;
...
@implementation EditAvailableWorkersViewController
...
//    _userimageBtn.userInteractionEnabled = NO;
    ...
    if([[_details valueForKey:@"gender"]  isEqual: @"male"]||[[_details valueForKey:@"gender"]  isEqual: @"0"]){
        gender = @"male";
    ...
    _nationalityTxtField.text=[nationality valueForKey:@"title"];
        ages =[_details valueForKey:@"ages"];
//    _ageNameTxtField.text=[age valueForKey:@"title"];
    _ageNameTxtField.text=[_details valueForKey:@"ages"];
...
- (void)uploadImagesWithProgressWithId:(NSString *)adId {
    ...
    NSString *serverURL = [NSString stringWithFormat:@"%@/%@", SERVER_URL,EDIT_AVAILABLEWORKERS];
    
    NSDictionary *parameters = @{@"member_id":[Utils loggedInUserIdStr],
                                 @"worker_id":[NSString stringWithFormat:@"%@",[_details valueForKey:@"id"]]
    ...
    //    UIImage *image = use_uiimage;
    UIImage *image = [UIImage imageWithCGImage:use_uiimage.CGImage scale:0.25 orientation:use_uiimage.imageOrientation];
    
    
    if (image == nil) {
        [self makePostCallForPage:EDIT_AVAILABLEWORKERS withParams:@{@"member_id":[Utils loggedInUserIdStr]
                                                                    ,@"worker_id":[NSString stringWithFormat:@"%@",[_details valueForKey:@"id"]],
                                                                     @"name":_nameTxtField.text,
                                                                    @"age":ages,
                                                                    @"nationality":[nationality valueForKey:@"id"],
...
//            [self.navigationController pushViewController:vc animated:YES];
    [self.navigationController popViewControllerAnimated:YES];
    //[self showSuccessMessage:Localized(@"Payment SucessFully")];
   // [self showSuccessMessage:Localized(@"Updated SucessFully")];
